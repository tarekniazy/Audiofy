...
def main():
    ...
    # pickle.dump(model, open("classical_model.sav", 'wb'))

    model = pickle.load(open("classical_model.sav", 'rb'))
    ...
    # (rate, sig) = wav.read("MS-SNSD/NoisySpeech_training/noisy1_SNRdb_0.0_clnsp1.wav")
